 ...
 * @wordpress-plugin
 * Plugin Name:       WP Book
 * Plugin URI:        https://github.com/ViragVaghasiya
...
require_once WPBK_INCLUDES_DIR . '/class-wpbk-plugin-deactivate.php';
...
class WPBk_WP_Book {
	...
	private function __construct() {
		...
		if ( class_exists( 'WPBk_Currency_Price_Manipulation' ) ) {
			...
			add_action(
				'wp_ajax_wpbk_base_currency_book_price_update',
